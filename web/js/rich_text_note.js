...
import { f as onMounted, q as onBeforeUnmount, d as defineComponent, u as h, x as watchEffect, b as ref, y as markRaw, s as shallowRef, z as customRef, n as nextTick, A as unref, B as getCurrentInstance, o as openBlock, c as createElementBlock, k as withModifiers, a as createBaseVNode, j as normalizeClass, i as createCommentVNode, C as createVNode, _ as _export_sfc, D as watch, E as createBlock, T as Teleport, l as computed, e as createApp } from "./_plugin-vue_export-helper-CusGlrPr.js";
...
const DownloadLink = Node2.create({
  name: "downloadLink",
  group: "block",
  atom: true,
  draggable: true,
  ...
  addCommands() {
    return {
      setDownloadLink: (attrs) => ({ commands: commands2 }) => {
  ...
  addNodeView() {
    return ({ node }) => {
      ...
      btn.textContent = node.attrs.label;
      btn.disabled = true;
      dom.appendChild(btn);
      if (node.attrs.quote) {
...
const _hoisted_3$1 = {
  class: "rtn-color-group",
  title: "Text Color"
};
const _hoisted_4 = ["value"];
const _hoisted_5 = { class: "rtn-modal-body" };
const _hoisted_6 = { class: "rtn-modal-footer" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "RichTextEditorModal",
  props: {
    initialHtml: {}
  },
  emits: ["save", "cancel"],
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function setHeading(event) {
      ...
      if (value === "p") {
        ...
        (_b = editor.value) == null ? void 0 : _b.chain().focus().toggleHeading({ level }).run();
      }
    }
    function toggleLink() {
    ...
    function setColor(color) {
      var _a;
      (_a = editor.value) == null ? void 0 : _a.chain().focus().setColor(color).run();
    }
    function addDownloadLink() {
      ...
      editor.value.chain().focus().setDownloadLink({ url, label, quote }).run();
    }
    function save() {
      if (!editor.value) return;
      const html2 = editor.value.getHTML();
      emit("save", html2);
    }
    onBeforeUnmount(() => {
      var _a;
    ...
    __expose({ getHTML: () => {
      var _a;
      return ((_a = editor.value) == null ? void 0 : _a.getHTML()) || "";
    } });
    return (_ctx, _cache) => {
      var _a;
      return openBlock(), createElementBlock("div", {
        ...
        _cache[24] || (_cache[24] = createBaseVNode("div", { class: "rtn-modal-header" }, [
          createBaseVNode("h3", null, "Rich Text Editor")
        ], -1)),
        unref(editor) ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          createBaseVNode("button", {
            onClick: _cache[0] || (_cache[0] = ($event) => unref(editor).chain().focus().toggleBold().run()),
            class: normalizeClass({ active: unref(editor).isActive("bold") }),
            title: "Bold (Ctrl+B)"
          }, [..._cache[14] || (_cache[14] = [
            createBaseVNode("strong", null, "B", -1)
          ])], 2),
          createBaseVNode("button", {
            onClick: _cache[1] || (_cache[1] = ($event) => unref(editor).chain().focus().toggleItalic().run()),
            class: normalizeClass({ active: unref(editor).isActive("italic") }),
            title: "Italic (Ctrl+I)"
          }, [..._cache[15] || (_cache[15] = [
            createBaseVNode("em", null, "I", -1)
          ])], 2),
          createBaseVNode("button", {
            onClick: _cache[2] || (_cache[2] = ($event) => unref(editor).chain().focus().toggleUnderline().run()),
            class: normalizeClass({ active: unref(editor).isActive("underline") }),
            title: "Underline (Ctrl+U)"
          }, [..._cache[16] || (_cache[16] = [
            createBaseVNode("u", null, "U", -1)
          ])], 2),
          _cache[18] || (_cache[18] = createBaseVNode("span", { class: "rtn-toolbar-sep" }, null, -1)),
          createBaseVNode("select", {
            onChange: _cache[3] || (_cache[3] = ($event) => setHeading($event)),
            value: currentHeading.value
          }, [..._cache[17] || (_cache[17] = [
            createBaseVNode("option", { value: "p" }, "Paragraph", -1),
            createBaseVNode("option", { value: "h1" }, "Heading 1", -1),
            createBaseVNode("option", { value: "h2" }, "Heading 2", -1),
            createBaseVNode("option", { value: "h3" }, "Heading 3", -1)
          ])], 40, _hoisted_2$1),
          _cache[19] || (_cache[19] = createBaseVNode("span", { class: "rtn-toolbar-sep" }, null, -1)),
          createBaseVNode("button", {
            onClick: _cache[4] || (_cache[4] = ($event) => unref(editor).chain().focus().toggleBulletList().run()),
            class: normalizeClass({ active: unref(editor).isActive("bulletList") }),
            title: "Bullet List"
          }, "• List", 2),
          createBaseVNode("button", {
            onClick: _cache[5] || (_cache[5] = ($event) => unref(editor).chain().focus().toggleOrderedList().run()),
            class: normalizeClass({ active: unref(editor).isActive("orderedList") }),
            title: "Ordered List"
          }, "1. List", 2),
          createBaseVNode("button", {
            onClick: _cache[6] || (_cache[6] = ($event) => unref(editor).chain().focus().toggleBlockquote().run()),
            class: normalizeClass({ active: unref(editor).isActive("blockquote") }),
            title: "Blockquote"
          }, "“ Quote", 2),
          _cache[20] || (_cache[20] = createBaseVNode("span", { class: "rtn-toolbar-sep" }, null, -1)),
          createBaseVNode("button", {
            onClick: _cache[7] || (_cache[7] = ($event) => unref(editor).chain().focus().setTextAlign("left").run()),
            class: normalizeClass({ active: unref(editor).isActive({ textAlign: "left" }) }),
            title: "Align Left"
          }, "←", 2),
          createBaseVNode("button", {
            onClick: _cache[8] || (_cache[8] = ($event) => unref(editor).chain().focus().setTextAlign("center").run()),
            class: normalizeClass({ active: unref(editor).isActive({ textAlign: "center" }) }),
            title: "Center"
          }, "↔", 2),
          createBaseVNode("button", {
            onClick: _cache[9] || (_cache[9] = ($event) => unref(editor).chain().focus().setTextAlign("right").run()),
            class: normalizeClass({ active: unref(editor).isActive({ textAlign: "right" }) }),
            title: "Align Right"
          }, "→", 2),
          _cache[21] || (_cache[21] = createBaseVNode("span", { class: "rtn-toolbar-sep" }, null, -1)),
          createBaseVNode("button", {
            onClick: toggleLink,
            class: normalizeClass({ active: unref(editor).isActive("link") }),
            title: "Insert Link"
          }, "Link", 2),
          _cache[22] || (_cache[22] = createBaseVNode("span", { class: "rtn-toolbar-sep" }, null, -1)),
          createBaseVNode("div", _hoisted_3$1, [
            createBaseVNode("input", {
              type: "color",
              class: "rtn-color-input",
              onInput: _cache[10] || (_cache[10] = ($event) => setColor($event.target.value)),
              value: ((_a = unref(editor)) == null ? void 0 : _a.getAttributes("textStyle").color) || "#ffffff"
            }, null, 40, _hoisted_4),
            createBaseVNode("button", {
              onClick: _cache[11] || (_cache[11] = ($event) => {
                var _a2;
                return (_a2 = unref(editor)) == null ? void 0 : _a2.chain().focus().unsetColor().run();
              }),
              class: "rtn-color-clear",
              title: "Clear Color"
            }, "C")
          ]),
          _cache[23] || (_cache[23] = createBaseVNode("span", { class: "rtn-toolbar-sep" }, null, -1)),
          createBaseVNode("button", {
        ...
        createBaseVNode("div", _hoisted_5, [
          createVNode(unref(EditorContent), {
            editor: unref(editor),
            class: "rtn-editor-content"
          }, null, 8, ["editor"])
        ]),
        createBaseVNode("div", _hoisted_6, [
          createBaseVNode("button", {
            class: "rtn-cancel-btn",
...
const RichTextEditorModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-75fd8e75"]]);
const _hoisted_1 = { class: "rtn-widget" };
const _hoisted_2 = { class: "rtn-header" };
const _hoisted_3 = ["innerHTML"];
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "RichTextNoteWidget",
  props: {
    initialHtml: {},
  ...
  setup(__props, { expose: __expose }) {
    ...
    const sanitizedHtml = computed(() => {
      return purify.sanitize(htmlContent.value, {
        ALLOWED_TAGS,
        ALLOWED_ATTR,
    ...
    function saveEdit(html2) {
      ...
      (_a = props.onChange) == null ? void 0 : _a.call(props, clean);
    }
    function cancelEdit() {
      editorVisible.value = false;
    }
    function deserialise(html2) {
      htmlContent.value = html2 || "";
    }
    function serialise() {
    ...
    function renderDownloadLinks() {
      ...
      const containers = contentRef.value.querySelectorAll(
    ...
    function handleContentClick(e) {
      ...
      const btn = target.closest(".rtn-dl-button");
      if (btn) {
        const wrapper = btn.closest(
          '[data-type="download-link"]'
        );
        if (wrapper == null ? void 0 : wrapper.dataset.url) {
          e.preventDefault();
          e.stopPropagation();
    ...
    __expose({ deserialise, serialise, cleanup });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("button", {
            class: "rtn-editor-btn",
        ...
        (openBlock(), createBlock(Teleport, { to: "body" }, [
          editorVisible.value ? (openBlock(), createElementBlock("div", {
            ...
            onClick: withModifiers(cancelEdit, ["self"])
          }, [
            createVNode(RichTextEditorModal, {
              "initial-html": workingHtml.value,
              onSave: saveEdit,
              onCancel: cancelEdit
            }, null, 8, ["initial-html"])
          ])) : createCommentVNode("", true)
...
const RichTextNoteWidget = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c805a01a"]]);
app.registerExtension({
  name: "Duffy.RichTextNote.Vue",
  async nodeCreated(node) {
    var _a;
    if (node.comfyClass !== "Duffy_RichTextNote") return;
    const dataWidget = (_a = node.widgets) == null ? void 0 : _a.find(
      (w) => w.name === "rich_text"
    );
    if (dataWidget) {
    ...
    const vueApp = createApp(RichTextNoteWidget, {
      initialHtml: (dataWidget == null ? void 0 : dataWidget.value) || "",
      onChange: (html2) => {
        if (dataWidget) dataWidget.value = html2;
    ...
    node.serialize = function() {
      ...
      const result = origSerialize == null ? void 0 : origSerialize.call(this);
      if (dataWidget) {
