...
class DuffyFluxMaxShift(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                io.Int.Input("width", default=1024, min=1, max=16384, step=1, tooltip="Image width in pixels"),
                io.Int.Input("height", default=1024, min=1, max=16384, step=1, tooltip="Image height in pixels"),
                io.Float.Input("multiplier", default=1.00, min=0.01, max=5.00, step=0.01, tooltip="Scaling multiplier applied to the pixel count"),
                io.Int.Input("divisor", default=1000000, min=1, max=100000000, step=1, tooltip="Divisor for the final value (default: 1M pixels)"),
            ],
            outputs=[
