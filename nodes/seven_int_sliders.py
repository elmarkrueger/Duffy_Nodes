...
class DuffySevenIntSliders(io.ComfyNode):
    """
    A node with seven integer sliders and customizable labels.
    """
    ...
    def define_schema(cls) -> io.Schema:
        ...
        return io.Schema(
            node_id="Duffy_SevenIntSliders",
            display_name="Seven Int Sliders",
            category="Duffy/Math",
            description="Seven integer sliders with customizable labels.",
            inputs=inputs,
            outputs=outputs,
        )
